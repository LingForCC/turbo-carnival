/**
 * LeftPanel Web Component
 * A collapsible left sidebar panel using Tailwind CSS
 */
export class LeftPanel extends HTMLElement {
  ...
  private render(): void {
    ...
    this.innerHTML = `
      <div class="${widthClass} ${overflowClass} bg-white border-r border-gray-200 flex flex-col transition-all duration-300 ease-in-out">
        <div class="p-4 border-b border-gray-200 flex justify-between items-center">
          <h2 class="text-lg font-semibold text-gray-800 m-0">Left Panel</h2>
          <button id="toggle-btn" class="p-1 hover:bg-gray-100 rounded flex items-center justify-center bg-transparent border-0 cursor-pointer" aria-label="Toggle left panel">
        ...
        <div class="flex-1 overflow-y-auto p-4">
          <p class="text-gray-600 m-0">This is the left sidebar content.</p>
        </div>
      </div>
    `;

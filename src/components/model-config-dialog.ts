...
export class ModelConfigDialog extends HTMLElement {
      ...
      <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <div>
              <h2 class="text-xl font-semibold text-gray-800 m-0">Model Configurations</h2>
  ...
  private renderModelConfigList(): string {
    if (this.modelConfigs.length === 0) {
      return `
        <div class="text-center py-8">
          <p class="text-sm text-gray-400 mb-4">No model configurations yet</p>
          <button id="add-model-config-btn" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg cursor-pointer border-0">
    ...
    return `
      <div class="flex justify-between items-center mb-4">
        ...
        <button id="add-model-config-btn" class="flex items-center gap-2 px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded text-sm font-medium cursor-pointer border-0">
      ...
      <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2">
            <span class="text-sm font-medium text-gray-800">${this.escapeHtml(config.name)}</span>
          </div>
        ...
        <div class="flex items-center gap-2">
          <button class="edit-model-config-btn p-1.5 hover:bg-gray-100 rounded cursor-pointer border-0 bg-transparent"
          ...
          <button class="delete-model-config-btn p-1.5 hover:bg-red-100 rounded cursor-pointer border-0 bg-transparent"
  ...
  private renderModelConfigForm(): string {
    ...
    return `
      <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-4 m-0">
      ...
      <form id="model-config-form" class="space-y-4">
        <!-- Model Config ID -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1" for="model-config-id">
          ...
          ${isEdit ?
            '<p class="text-xs text-gray-400 mt-1">Model Configuration ID cannot be changed</p>' :
        ...
        <!-- Display Name -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1" for="model-config-name">
        ...
        <!-- Model -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1" for="model-config-model">
        ...
        <!-- Max Tokens -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1" for="model-config-max-tokens">
            Max Tokens (Optional)
          </label>
        ...
        <!-- Top P -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1" for="model-config-top-p">
            Top P (Optional)
          </label>
        ...
        <!-- Extra Properties -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1" for="model-config-extra">

import { getClipboardHistoryManagementAPI } from '../api/clipboard-history-management';
import { getSettingsManagementAPI } from '../api/settings-management';
import type { ClipboardHistoryItem, ClipboardHistoryManagementAPI } from '../types/clipboard-history-management';

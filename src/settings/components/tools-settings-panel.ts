import { getToolManagementAPI } from '../../tools/api';
import type { ToolManagementAPI, Tool, MCPServerConfig } from '../../tools/types';

/**
 * ToolsSettingsPanel Web Component
 * Panel for managing custom tools and MCP servers within Settings Dialog
 */
export class ToolsSettingsPanel extends HTMLElement {
  ...
  private async testTool(): Promise<void> {
    ...
    await import('../../tools/components/tool-test-dialog');
...
customElements.define('tools-settings-panel', ToolsSettingsPanel);

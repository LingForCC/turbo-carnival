...
import type { OpenAIMessage, OpenAIToolCall } from '../../llm/main/streaming/openai';

/**
 * Transformer for OpenAI message format
 * Converts OpenAI native message format to ChatMessage format for UI display
 */
export class OpenAITransformer {
  /**
   * Transform OpenAI messages to ChatMessage format

...
- `conversation-panel` - Reusable chat interface (event-driven, tool call indicators, injectable renderers, message factories for user, assistant, and tool call messages)
